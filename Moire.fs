~/downloads $                                   ~/downloads $ cat moire.fs                      \ ================================================================                              \  M O I R É   L I G H T S  —  Gforth terminal animation                                        \                                               \  Moiré interference between two animated concentric-ring                                      \  patterns, rendered in 256-colour ANSI on any VT100 terminal.                                 \                                               \  Run:   gforth moire.fs                       \  Exit:  press any key  (or Ctrl-C)            \ ================================================================                                                                              80 constant COLS                                24 constant ROWS                                                                                \ ─── integer print without trailing space ───────────────────────                              : n.  ( n -- )  s>d <# #s #> type ;                                                             \ ─── ANSI / VT100 terminal control ──────────────────────────────                              : esc          27 emit ;                        : cls          esc ." [2J" esc ." [H" ;
